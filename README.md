...
## Instruction Format
Byte 0: op_code -> Encodes operation, mode, and unit select
...
Byte 1: op1 -> Source register / immediate value / jump address	

Byte 2: op2 -> Destination register / second source register
